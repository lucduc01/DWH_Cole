...
with DAG(
    ...
    # Fact Doanh thu TOT
    extract_Doanh_thu_TOT = BashOperator(task_id="extract_fact_Doanh_thu_TOT", bash_command="python ~/DWH_Cole_Project/src/extract/Fact/Doanh_thu_TOT.py")
    transform_Doanh_thu_TOT = BashOperator(task_id="transform_fact_Doanh_thu_TOT", bash_command="python ~/DWH_Cole_Project/src/transform/Fact/Doanh_thu_TOT.py")
    load_Doanh_thu_TOT = BashOperator(task_id="load_fact_Doanh_thu_TOT", bash_command="python ~/DWH_Cole_Project/src/load/Fact/Doanh_thu_TOT.py")
    
    # Fact Doanh thu TOA
    extract_Doanh_thu_TOA = BashOperator(task_id="extract_fact_Doanh_thu_TOA", bash_command="python ~/DWH_Cole_Project/src/extract/Fact/Doanh_thu_TOA.py")
    transform_Doanh_thu_TOA = BashOperator(task_id="transform_fact_Doanh_thu_TOA", bash_command="python ~/DWH_Cole_Project/src/transform/Fact/Doanh_thu_TOA.py")
    load_Doanh_thu_TOA = BashOperator(task_id="load_fact_Doanh_thu_TOA", bash_command="python ~/DWH_Cole_Project/src/load/Fact/Doanh_thu_TOA.py")

    # Fact Doanh số TOT
    extract_Doanh_so_TOT = BashOperator(task_id="extract_fact_Doanh_so_TOT", bash_command="python ~/DWH_Cole_Project/src/extract/Fact/Doanh_so_TOT.py")
    transform_Doanh_so_TOT = BashOperator(task_id="transform_fact_Doanh_so_TOT", bash_command="python ~/DWH_Cole_Project/src/transform/Fact/Doanh_so_TOT.py")
    load_Doanh_so_TOT = BashOperator(task_id="load_fact_Doanh_so_TOT", bash_command="python ~/DWH_Cole_Project/src/load/Fact/Doanh_so_TOT.py")

    # Fact Doanh số TOA
    extract_Doanh_so_TOA = BashOperator(task_id="extract_fact_Doanh_so_TOA", bash_command="python ~/DWH_Cole_Project/src/extract/Fact/Doanh_so_TOA.py")
    transform_Doanh_so_TOA = BashOperator(task_id="transform_fact_Doanh_so_TOA", bash_command="python ~/DWH_Cole_Project/src/transform/Fact/Doanh_so_TOA.py")
    load_Doanh_so_TOA = BashOperator(task_id="load_fact_Doanh_so_TOA", bash_command="python ~/DWH_Cole_Project/src/load/Fact/Doanh_so_TOA.py")

    # Fact L7 + L8 TOA
    extract_L7_8_TOA = BashOperator(task_id="extract_fact_L7_8_TOA", bash_command="python ~/DWH_Cole_Project/src/extract/Fact/L7_8_TOA.py")
    transform_L7_8_TOA = BashOperator(task_id="transform_fact_L7_8_TOA", bash_command="python ~/DWH_Cole_Project/src/transform/Fact/L7_8_TOA.py")
    load_L7_8_TOA = BashOperator(task_id="load_fact_L7_8_TOA", bash_command="python ~/DWH_Cole_Project/src/load/Fact/L7_8_TOA.py")

    # Fact L1 -> L8 Chuyển đổi
    extract_L1_8_FA= BashOperator(task_id="extract_L1_8_FA", bash_command="python ~/DWH_Cole_Project/src/extract/L1_8_FA.py")
    
    # Fact L1 -> L8 Messenger
    extract_L1_8_Mess=BashOperator(task_id="extract_L1_8_Mess", bash_command="python ~/DWH_Cole_Project/src/extract/L1_8_Mess.py")
    ...
    transform_Chien_dich_Meta=BashOperator(task_id="transform_Chien_dich_Meta", bash_command="python ~/DWH_Cole_Project/src/transform/Chien_dich_Meta.py")
    ...
    # Chia  4 nhánh từ transform_Chi_phi_FA_TOT
    ...
    # Nhánh con của transform_Chi_phi_FA_TOA
    ...
    # Chia song song 3 nhánh từ transform_Chi_phi_Mess_TOT
    ...
    # Nhánh con của transform_Chi_phi_Mess_TOA
    ...
    [
        extract_Chi_phi_FA_TOT, extract_Chi_phi_Mess_TOT,extract_Chi_phi_Branding,extract_Chi_phi_CTV
    ] >> extract_Chien_dich_Meta
