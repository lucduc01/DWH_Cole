...
#Lấy dữ liệu
df_source=pd.read_csv("~/DWH_Cole_Project/data_result/Chi_phi_FA_transformed.csv")

sql_query=""" select * from Fact_Chi_phi_FA_TOT where Thoi_gian >= DATEADD(MONTH, -5, GETDATE())
          """
...
syncer = SCDType1SyncMultipleKey(df_source, df_target, key_columns=["Thoi_gian", "Ma_khoa_hoc","Ma_marketer"], table_name="Fact_Chi_phi_FA_TOT")
syncer.sync()