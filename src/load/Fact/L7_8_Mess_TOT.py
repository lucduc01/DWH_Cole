...
#Lấy dữ liệu
df_source=pd.read_csv("~/DWH_Cole_Project/data_result/L78_Mess_transformed.csv")

sql_query=""" select * from Fact_L7_8_Mess_TOT where Thoi_gian >= DATEADD(MONTH, -24, GETDATE())
          """
...
syncer = SCDType1SyncMultipleKey(df_source, df_target, key_columns=["Thoi_gian", "Ma_khoa_hoc","Ma_marketer"], table_name="Fact_L7_8_Mess_TOT")
syncer.sync()