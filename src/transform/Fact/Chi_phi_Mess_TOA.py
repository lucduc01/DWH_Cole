...
df= pd.read_csv("~/DWH_Cole_Project/data_result/Chi_phi_Mess_transformed.csv")
df_78=pd.read_csv("~/DWH_Cole_Project/data_result/L78_Mess_transformed.csv")
...
def adjust_group_values(group):
    ...
    if count > 1:
        ...
        adjusted_values = {
            ...
            'So_mess': round(first_values['So_mess'] / count),
        ...
        group['So_mess'] = adjusted_values['So_mess']
...
final=valid_records_processed[['Chi_phi','Thoi_gian','Ma_lop_hoc','Ma_marketer','L1','L1_L1C','So_mess']]

final.to_csv("~/DWH_Cole_Project/data_result/Chi_phi_Mess_TOA_transformed.csv",index=False)
final_L78.to_csv("~/DWH_Cole_Project/data_result/L78_Mess_TOA_transformed.csv",index=False)